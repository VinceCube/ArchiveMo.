                    ...
                    <?php
                      ...
                      <tr>
                        ...
                        if($row["sentiment_result"] == "Negative"){
                          echo "<img src='img/sad.jpg' style='width: auto; height: 50px; border-radius: 50%;'>";
                        }
                        else if($row["sentiment_result"] == "Positive"){
                          echo "<img src='img/happy.jpg' style='width: auto; height: 50px; border-radius: 50%;'>";
                        }
                        else{
                          echo "<img src='img/smile.jpg' style='width: auto; height: 50px; border-radius: 50%;'>";
                        }
                         ?></td>
