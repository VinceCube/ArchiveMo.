    ...
    ?>
      ...
      <main id="main">
        ...
        function getExistingFile($email)
        {
          ...
          $query = "SELECT moa FROM moa WHERE email = ?";
        ...
        if (isset($_POST['submit'])) {
          if (!$existing_file) {
            ...
            $sql = "INSERT INTO `moa` (`id`, `email`, `moa`, `date`) VALUES (NULL, ?, ?, ?)";
            $stmt = mysqli_prepare($conn, $sql);
            mysqli_stmt_bind_param($stmt, "sss", $email, $pname, $date);

            if (mysqli_stmt_execute($stmt)) {
              $_SESSION['message'] = '<script>
                swal("Success!", "Memorandum of Agreement successfully submitted.", "success");
            </script>';
              echo "<script>window.location.href = 'moa_form.php';</script>";
              exit();
            } else {
        ...
        <section id="narrative" class="narrative">
          ...
          if (isset($_POST['deletedata'])) {
            ...
            $sql = "DELETE FROM moa WHERE id = $id";
                ...
                <div class="card recent-sales overflow-auto">
                  <div class="card-body">
                    <table class="table datatable">
                      ...
                      <tbody>
                        <?php
                        $result = mysqli_query($conn, "SELECT * FROM moa WHERE email = '$email'");
                        while ($row = mysqli_fetch_array($result)) {
                        ?>
                          <tr>
