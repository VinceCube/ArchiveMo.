    ...
    ?>
      ...
      <main id="main">
        ...
        if (isset($_POST['submit'])) {
          ...
          $sql = "INSERT INTO `concent` (`id`, `email`, `concent`, `date`) VALUES (NULL, ?, ?, ?)";
      ...
      swal("Success!", "Parent concent successfully submitted.", "success");
      </script>`';
                ...
                <div class="card recent-sales overflow-auto">
                  ...
                  <div class="card-body">
                    <table class="table datatable">
                      ...
                      <tbody>
                        <?php
                        $result = mysqli_query($conn, "SELECT * FROM concent WHERE concent.email = '$email'");
                        while ($row = mysqli_fetch_array($result)) {
                        ?>
                          <tr>
