...
<body>
    ...
    <main id="main" class="main">
        ...
        if (isset($_POST['insertdata'])) {
            ...
            $progPosition = $_POST['position'];


            $query = mysqli_query($conn, "INSERT INTO `position` (`id`, `prog_position`) VALUES (NULL, '$progPosition')");
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="position" class="form-control" placeholder="Enter Position/Designation" required>
                            </div>
                        </div>
        ...
        if (isset($_POST['updatedata'])) {
            ...
            $name = $_POST['prog_Position'];


            $sql = "UPDATE position  SET prog_position ='$name' WHERE id='$id'";
        ...
        <div class="col-12">
            <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                    <h5 class="card-title">Programmer/Developer List</h5><button type="button" class="btn btn-primary insertmodal" data-bs-target="#insertmodal" data-bs-toggle="modal" style="float: right; margin-top: -50px;"><i class="bi bi-plus" style="font-size: 15px;"></i> ADD </button>
                        ...
                        <tbody>
                            ...
                            ?>
                                <tr>
                                    ...
                                    <td><?php echo $row["prog_position"]; ?></td>
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="row mb-3">
                                                                ...
                                                                <div class="col-md-8 col-lg-9">
                                                                    <input type="text" class="form-control" name="prog_Position" value="<?php echo $row["prog_position"]; ?>">
                                                                </div>
                                                            </div>
