...
<body>
    ...
    <main id="main" class="main">
        ...
        if (isset($_POST['insertdata'])) {
            ...
            $query = mysqli_query($conn, "INSERT INTO `major` (`id`, `specialization`) VALUES (NULL, '$newmajor')");
            ...
            if ($query) {
                ...
                <script>
                swal("Specialization Added!", "You created new specialization!", "success");

                </script>
                
                `';
                echo "<script>window.location.href = 'specialization.php';</script>";
                exit();
            } else {
                $_SESSION['message'] = '    <script>
                swal("Something went wrong!", "There is a problem inserting specialization.", "warning");
            ...
            <div class="modal-dialog modal-dialog-centered" role="document">
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title" id="exampleModalLabel">Add New Specialization </h5>
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="major" class="form-control" placeholder="Enter Specialization" required>
                            </div>
                        </div>
        ...
        if (isset($_POST['deletedata'])) {
            ...
            if ($query_run) {
                ...
                <script>
                swal("Success!", "Poof! specialization has been deleted!", "success");
                </script>
                `';
                echo "<script>window.location.href = 'specialization.php';</script>";
                exit;
                ...
                $_SESSION['message'] = '    <script>
                swal("Something went wrong!", "There is a problem deleting specialization.", "warning");
                </script>';
                echo "<script>window.location.href = 'specialization.php';</script>";
                exit();
            }
        ...
        if (isset($_POST['updatedata'])) {
            ...
            $name = $_POST['newspecialization'];


            $sql = "UPDATE major  SET specialization ='$name' WHERE id='$id'";
            ...
            if ($query_run) {
                $_SESSION['message'] = '
                <script>
                    swal("Success!", "Specialization has been updated!", "success");
                    </script>
                    ';
                echo "<script>window.location.href = 'specialization.php';</script>";
                exit;
            ...
            <div class="row">
                <div class="col-12">
                    <div class="card recent-sales overflow-auto">
                        ...
                        <div class="card-body">
                            <h5 class="card-title">Specialization List</h5><button type="button" class="btn btn-primary insertmodal" data-bs-target="#insertmodal" data-bs-toggle="modal" style="float: right; margin-top: -50px;"><i class="bi bi-plus" style="font-size: 15px;"></i> ADD </button>
                                                        ...
                                                        <div class="modal-content">
                                                            ...
                                                            <form action="" method="POST">
                                                                ...
                                                                <div class="modal-body">
                                                                    ...
                                                                    <div class="row mb-3">
                                                                        <label for="fullName" class="col-md-2 col-lg-3 col-form-label" style="font-size: 18px;">Specialization</label>
                                                                        <div class="col-md-8 col-lg-9">
                                                                            <input type="text" class="form-control" name="newspecialization" value="<?php echo $row["specialization"]; ?>">
                                                                        </div>
                                                                    </div>
