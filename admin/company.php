...
<body>
    ...
    <main id="main" class="main">
        ...
        if (isset($_POST['insertdata'])) {
            ...
            $query = mysqli_query($conn, "INSERT INTO `company` (`id`, `organization`) VALUES (NULL, '$companyName')");
            ...
            if ($query) {
                ...
                <script>
                swal("Organization Added!", "You created another organization!", "success");
                ...
                swal("Something went wrong!", "There is a problem inserting organization.", "warning");
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="company" class="form-control" placeholder="Enter Company or Organization" required>
                            </div>
                        </div>
        ...
        if (isset($_POST['deletedata'])) {
            ...
            if ($query_run) {
                ...
                <script>
                swal("Success!", "Poof! Organization has been deleted!", "success");
                </script>
                `';
                echo "<script>window.location.href = 'company.php';</script>";
                exit;
                ...
                $_SESSION['message'] = '    <script>
                swal("Something went wrong!", "There is a problem deleting organization.", "warning");
                </script>';
                echo "<script>window.location.href = 'company.php';</script>";
                exit();
            }
        ...
        if (isset($_POST['updatedata'])) {
            ...
            $sql = "UPDATE company  SET organization ='$name' WHERE id='$id'";
            ...
            if ($query_run) {
                $_SESSION['message'] = '
                <script>
                    swal("Success!", "Organization has been updated!", "success");
                    </script>
                    ';
                echo "<script>window.location.href = 'company.php';</script>";
                exit;
        ...
        <div class="col-12">
            <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                    <h5 class="card-title">Organization List</h5><button type="button" class="btn btn-primary insertmodal" data-bs-target="#insertmodal" data-bs-toggle="modal" style="float: right; margin-top: -50px;"><i class="bi bi-plus" style="font-size: 15px;"></i> ADD </button>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form action="" method="POST">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="row mb-3">
                                                                <label for="fullName" class="col-md-2 col-lg-3 col-form-label" style="font-size: 18px;">Organization</label>
                                                                <div class="col-md-8 col-lg-9">
                                                                    <input type="text" class="form-control" name="companyName" value="<?php echo $row["organization"]; ?>">
                                                                </div>
                                                            </div>
