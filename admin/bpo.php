...
<body>
    ...
    <main id="main" class="main">
        ...
        <div class="pagetitle">
            ...
            <nav>
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active">BPO</li>
                </ol>
            </nav>
        </div><!-- End Page Title -->
        ...
        if (isset($_POST['insertdata'])) {
            ...
            $bpoPosition = $_POST['bpo_Position'];


            $query = mysqli_query($conn, "INSERT INTO `bpo` (`id`, `bpo_position`) VALUES (NULL, '$bpoPosition')");
            ...
            if ($query) {
                ...
                <script>
                swal("Position Added!", "You created another position!", "success");

                </script>
                
                `';
                echo "<script>window.location.href = 'bpo.php';</script>";
                exit();
            } else {
                $_SESSION['message'] = '    <script>
                swal("Something went wrong!", "There is a problem inserting position.", "warning");
                    ...
                    <form action="" method="POST">
                        ...
                        <div class="modal-body">
                            <div class="form-group">
                                ...
                                <input type="text" name="bpo_Position" class="form-control" placeholder="Enter Position/Designation" required>
                            </div>
                        </div>
        ...
        if (isset($_POST['deletedata'])) {
            ...
            $query = "DELETE FROM bpo WHERE id='$id'";
            ...
            if ($query_run) {
                ...
                <script>
                swal("Success!", "Poof! Position has been deleted!", "success");
                </script>
                `';
                echo "<script>window.location.href = 'bpo.php';</script>";
                exit;
                ...
                $_SESSION['message'] = '    <script>
                swal("Something went wrong!", "There is a problem deleting position.", "warning");
                </script>';
                echo "<script>window.location.href = 'bpo.php';</script>";
                exit();
            }
        ...
        if (isset($_POST['updatedata'])) {
            ...
            $name = $_POST['BPO_position'];


            $sql = "UPDATE bpo  SET bpo_position ='$name' WHERE id='$id'";
            ...
            if ($query_run) {
                $_SESSION['message'] = '
                <script>
                    swal("Success!", "Position has been updated!", "success");
                    </script>
                    ';
                echo "<script>window.location.href = 'bpo.php';</script>";
                exit;
        ...
        <div class="col-12">
            <div class="card recent-sales overflow-auto">
                ...
                <div class="card-body">
                    <h5 class="card-title">BPO Position List</h5><button type="button" class="btn btn-primary insertmodal" data-bs-target="#insertmodal" data-bs-toggle="modal" style="float: right; margin-top: -50px;"><i class="bi bi-plus" style="font-size: 15px;"></i> ADD </button>
                    ...
                    <table class="table table-borderless datatable">
                        ...
                        <tbody>
                            ...
                            $result = mysqli_query($conn, "SELECT * FROM bpo");
                            while ($row = mysqli_fetch_array($result)) {

                            ?>
                                <tr>
                                    <td scope="row"><?php echo $row["id"]; ?></td>
                                    <td><?php echo $row["bpo_position"]; ?></td>
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <form action="" method="POST">
                                                        ...
                                                        <div class="modal-body">
                                                            ...
                                                            <div class="row mb-3">
                                                                <label for="fullName" class="col-md-2 col-lg-3 col-form-label" style="font-size: 18px;">Position</label>
                                                                <div class="col-md-8 col-lg-9">
                                                                    <input type="text" class="form-control" name="BPO_position" value="<?php echo $row["bpo_position"]; ?>">
                                                                </div>
                                                            </div>
